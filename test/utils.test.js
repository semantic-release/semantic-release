...
test("extractGitLogNotes", (t) => {
  t.deepEqual(extractGitLogNotes(`{"channels":[null]}`), { channels: [null] });
  t.deepEqual(extractGitLogNotes(`{"channels":["develop"]}\n{"channels":[null]}\n`), { channels: ["develop", null] });
});

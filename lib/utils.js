...
function makePrereleaseVersion(prereleaseVersionFormat, version, prereleaseBranch, prereleaseVersion) {
  return template(prereleaseVersionFormat)({version, prereleaseBranch, prereleaseVersion});
}

...
This can be caused by either:
 - a misconfiguration of the [repositoryUrl option](${linkify('docs/usage/configuration.md#repositoryurl')})
 - the repository being unavailable
 - or missing push permission for the user asssociated wit the [Git credentials on your CI environment](${linkify(
   'docs/usage/ci-configuration.md#authentication'
 )})`,
  }),
  INVALIDTAGFORMAT: ({tagFormat}) => ({

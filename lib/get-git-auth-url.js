...
module.exports = async ({cwd, env, branch, options: {repositoryUrl}}) => {
  const GIT_TOKENS = {
    ...
    GH_TOKEN: undefined,
    //  Github Apps (including GitHub Actions) require the "x-access-token:" prefix for git access
    // https://developer.github.com/apps/building-github-apps/authenticating-with-github-apps/#http-based-git-access-by-an-installation
    GITHUB_TOKEN: (isNil(env.GITHUB_ACTION) || isNil(env.GITHUB_APP)) ? undefined : 'x-access-token:',

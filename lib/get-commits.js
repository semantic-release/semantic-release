...
import { getInnerSquashedCommits } from "./github.js";
...
export default async ({
  ...
  const commits = options.squashMerge
    ? await getInnerSquashedCommits(from, to, { cwd, env, options })
    : await getCommits(from, to, { cwd, env });

...
Usage:
  semantic-release [options] [plugins]`);
    ...
    .option("ta", { alias: "tag-annotate", describe: "Toggle tag annotation", type: "boolean", group: "Options" })
    .option("ts", { alias: "tag-sign", describe: "Toggle tag signing", type: "boolean", group: "Options" })

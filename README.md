...
Tools such as [commitizen](https://github.com/commitizen/cz-cli), [commitlint](https://github.com/conventional-changelog/commitlint) or [semantic-git-commit-cli](https://github.com/JPeer264/node-semantic-git-commit-cli) or even [git commit hooks](https://github.com/hazcod/semantic-commit-hook) can be used to help contributors and enforce valid commit messages.
